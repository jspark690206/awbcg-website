...
const messages = [
  ...
  },
  {
    ...
    content: `저희 올윈비시지의 모든 임직원은 회사 상호와 걸맞게 "AWBCG(All Winner Brilliant Consulting Group)" 당사와 거래하는 모든 고객과 동반성장을 목표로 하고 있으며, 서울·경기 수도권 중심에서 영남지역 중심으로 4차 산업의 혜택을 누릴 수 있도록 지역에서 바닥을 다져나가는 기업이 되기 위하여 최선을 다하고 있습니다.`,
  },
];
